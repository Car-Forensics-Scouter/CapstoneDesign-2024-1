...
class ObdLogDataRepositoryTest {
  ...
  public void testSelectLogByDeviceidAndDay() {
    ...
    List<ObdLog> dvId01and240401 = obdLogDataRepository.findObdLogByDeviceidAndDay(deviceId1,
        start240401, end240401);

    // deviceId2의 240401 날짜의 모든 로그 출력 (expected: 2)
    List<ObdLog> dvId02and240401 = obdLogDataRepository.findObdLogByDeviceidAndDay(deviceId1,
        start240401, end240401);

    // 240411 날짜의 모든 로그 출력 (expected: 1)
    List<ObdLog> dvId02and240411 = obdLogDataRepository.findObdLogByDeviceidAndDay(deviceId2,
